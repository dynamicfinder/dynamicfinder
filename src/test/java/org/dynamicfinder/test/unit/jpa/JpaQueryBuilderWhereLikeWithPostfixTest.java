 ...
 */
public class JpaQueryBuilderWhereLikeWithPostfixTest 
implements NullableAndRestrictionLogicSpecs {

	private static final Logger logger = LoggerFactory.getLogger(JpaQueryBuilderWhereLikeWithPostfixTest.class);
	...
	public void nullableDiscardWithOR() {
		...
		restrictions.add(new JpaRestriction("name", RestrictionType.LIKE_WITH_POSTFIX, Nullable.DISCARD, RestrictionLogic.OR, "xsalefter"));
		restrictions.add(new JpaRestriction("birthDate", RestrictionType.LIKE_WITH_POSTFIX, Nullable.DISCARD, RestrictionLogic.OR, birth));
	...
	public void nullableDiscardWithAND() {
		...
		List<Restriction> restrictions = new ArrayList<Restriction>();
		restrictions.add(new JpaRestriction("name", RestrictionType.LIKE_WITH_POSTFIX, Nullable.DISCARD, RestrictionLogic.AND, "xsalefter"));
		restrictions.add(new JpaRestriction("birthDate", RestrictionType.LIKE_WITH_POSTFIX, Nullable.DISCARD, RestrictionLogic.AND, birth));
		restrictions.add(new JpaRestriction("gender", RestrictionType.LIKE_WITH_POSTFIX, Nullable.DISCARD, RestrictionLogic.AND));
	...
	public void nullableKeepWithOR() {
		...
		List<Restriction> restrictions = new ArrayList<Restriction>();
		restrictions.add(new JpaRestriction("birthDate", RestrictionType.LIKE_WITH_POSTFIX, Nullable.KEEP, RestrictionLogic.OR, birth));
	...
	public void nullableKeepWithORWithException() {
		...
		List<Restriction> restrictions = new ArrayList<Restriction>();
		restrictions.add(new JpaRestriction("name", RestrictionType.LIKE_WITH_POSTFIX, Nullable.KEEP, RestrictionLogic.OR));
		restrictions.add(new JpaRestriction("birthDate", RestrictionType.LIKE_WITH_POSTFIX, Nullable.KEEP, RestrictionLogic.OR, birth));
		restrictions.add(new JpaRestriction("gender", RestrictionType.LIKE_WITH_POSTFIX, Nullable.KEEP, RestrictionLogic.OR));
	...
	public void nullableKeepWithAND() {
		...
		List<Restriction> restrictions = new ArrayList<Restriction>();
		restrictions.add(new JpaRestriction("name", RestrictionType.LIKE_WITH_POSTFIX, Nullable.KEEP, "xsalefter"));
		restrictions.add(new JpaRestriction("gender", RestrictionType.LIKE_WITH_POSTFIX, Nullable.KEEP, Gender.Male));
	...
	public void combinedNullableAndLogic() {
		...
		List<Restriction> restrictions = new ArrayList<Restriction>();
		restrictions.add(new JpaRestriction("name", RestrictionType.LIKE_WITH_POSTFIX, Nullable.DISCARD, RestrictionLogic.OR, "xsalefter"));
		restrictions.add(new JpaRestriction("birthDate", RestrictionType.LIKE_WITH_POSTFIX, Nullable.DISCARD, birth));
		restrictions.add(new JpaRestriction("hobby", RestrictionType.LIKE_WITH_POSTFIX, Nullable.DISCARD, "coding"));
	...
	public void doesNotProduceAnyRestriction() {
		...
		List<Restriction> restrictions = new ArrayList<Restriction>();
		restrictions.add(new JpaRestriction("name", RestrictionType.LIKE_WITH_POSTFIX, RestrictionLogic.OR));
		restrictions.add(new JpaRestriction("birthDate", RestrictionType.LIKE));
		restrictions.add(new JpaRestriction("gender", RestrictionType.LIKE_WITH_POSTFIX, RestrictionLogic.OR));
