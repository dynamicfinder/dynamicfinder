 ...
 */
public class JpaQueryBuilderWhereLesserEqualTest 
implements NullableAndRestrictionLogicSpecs {

	private static final Logger logger = LoggerFactory.getLogger(JpaQueryBuilderWhereLesserEqualTest.class);
	...
	public void nullableDiscardWithOR() {
		...
		restrictions.add(new JpaRestriction("name", RestrictionType.LESSER_EQUAL, Nullable.DISCARD, RestrictionLogic.OR, "some name"));
		restrictions.add(new JpaRestriction("birthDate", RestrictionType.LESSER_EQUAL, Nullable.DISCARD, RestrictionLogic.OR, birth));
		restrictions.add(new JpaRestriction("name", RestrictionType.LESSER_EQUAL, Nullable.DISCARD, RestrictionLogic.OR));
	...
	public void nullableDiscardWithAND() {
		...
		List<Restriction> restrictions = new ArrayList<Restriction>();
		restrictions.add(new JpaRestriction("name", RestrictionType.LESSER_EQUAL, Nullable.DISCARD, "xsalefter"));
		restrictions.add(new JpaRestriction("birthDate", RestrictionType.LESSER_EQUAL, Nullable.DISCARD, birth));
		restrictions.add(new JpaRestriction("gender", RestrictionType.LESSER_EQUAL, Nullable.DISCARD, Gender.Male));
	...
	public void nullableKeepWithOR() {
		...
		List<Restriction> restrictions = new ArrayList<Restriction>();
		restrictions.add(new JpaRestriction("name", RestrictionType.LESSER_EQUAL, Nullable.KEEP, RestrictionLogic.OR, "some name"));
		restrictions.add(new JpaRestriction("birthDate", RestrictionType.LESSER_EQUAL, Nullable.KEEP, RestrictionLogic.OR, birth));
		restrictions.add(new JpaRestriction("gender", RestrictionType.LESSER_EQUAL, Nullable.KEEP, RestrictionLogic.OR, Gender.Female));
	...
	public void nullableKeepWithAND() {
		...
		List<Restriction> restrictions = new ArrayList<Restriction>();
		restrictions.add(new JpaRestriction("name", RestrictionType.LESSER_EQUAL, Nullable.KEEP, "john"));
		restrictions.add(new JpaRestriction("birthDate", RestrictionType.LESSER_EQUAL, Nullable.KEEP, birth));
		restrictions.add(new JpaRestriction("gender", RestrictionType.LESSER_EQUAL, Nullable.KEEP, Gender.Male));
		restrictions.add(new JpaRestriction("gender", RestrictionType.LESSER_EQUAL, Nullable.KEEP, Gender.Female));
	...
	public void nullableKeepThrowException() {
		...
		List<Restriction> restrictions = new ArrayList<Restriction>();
		restrictions.add(new JpaRestriction("name", RestrictionType.LESSER_EQUAL, Nullable.KEEP, RestrictionLogic.OR));
		restrictions.add(new JpaRestriction("hobby", RestrictionType.LESSER_EQUAL, Nullable.KEEP));
