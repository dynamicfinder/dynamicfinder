 ...
 */
public class JpaQueryBuilderWhereLikeTest 
implements NullableAndRestrictionLogicSpecs {
	...
	public void nullableDiscardWithOR() {
		...
		restrictions.add(new JpaRestriction("birthDate", RestrictionType.LIKE, Nullable.DISCARD, RestrictionLogic.OR, birth));
