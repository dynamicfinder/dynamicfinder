 ...
 */
public class JpaQueryBuilderWhereGreaterTest 
implements NullableAndRestrictionLogicSpecs {

	private static final Logger logger = LoggerFactory.getLogger(JpaQueryBuilderWhereGreaterTest.class);
	...
	public void nullableDiscardWithOR() {
		...
		restrictions.add(new JpaRestriction("name", RestrictionType.GREATER, Nullable.DISCARD, RestrictionLogic.OR, "some name"));
		restrictions.add(new JpaRestriction("birthDate", RestrictionType.GREATER, Nullable.DISCARD, RestrictionLogic.OR, birth));
		restrictions.add(new JpaRestriction("name", RestrictionType.GREATER, Nullable.DISCARD, RestrictionLogic.OR));
	...
	public void nullableDiscardWithAND() {
		...
		List<Restriction> restrictions = new ArrayList<Restriction>();
		restrictions.add(new JpaRestriction("name", RestrictionType.GREATER, Nullable.DISCARD, "xsalefter"));
		restrictions.add(new JpaRestriction("birthDate", RestrictionType.GREATER, Nullable.DISCARD, birth));
		restrictions.add(new JpaRestriction("gender", RestrictionType.GREATER, Nullable.DISCARD, Gender.Male));
	...
	public void nullableKeepWithOR() {
		...
		List<Restriction> restrictions = new ArrayList<Restriction>();
		restrictions.add(new JpaRestriction("name", RestrictionType.GREATER, Nullable.KEEP, RestrictionLogic.OR, "some name"));
		restrictions.add(new JpaRestriction("birthDate", RestrictionType.GREATER, Nullable.KEEP, RestrictionLogic.OR, birth));
		restrictions.add(new JpaRestriction("gender", RestrictionType.GREATER, Nullable.KEEP, RestrictionLogic.OR, Gender.Female));
	...
	public void nullableKeepWithAND() {
		...
		List<Restriction> restrictions = new ArrayList<Restriction>();
		restrictions.add(new JpaRestriction("name", RestrictionType.GREATER, Nullable.KEEP, "john"));
		restrictions.add(new JpaRestriction("birthDate", RestrictionType.GREATER, Nullable.KEEP, birth));
		restrictions.add(new JpaRestriction("gender", RestrictionType.GREATER, Nullable.KEEP, Gender.Male));
		restrictions.add(new JpaRestriction("gender", RestrictionType.GREATER, Nullable.KEEP, Gender.Female));
