 ...
 */
public class JpaQueryBuilderWithLikeWithPostfixRestrictionTest extends AbstractJpaIntegrationTest {

	static final Logger logger = LoggerFactory.getLogger(JpaQueryBuilderWithLikeWithPostfixRestrictionTest.class);
	...
	public void restrictionForStringTest() {
		...
		restrictions.add(new JpaRestriction("lastName", RestrictionType.LIKE_WITH_POSTFIX, "an"));
