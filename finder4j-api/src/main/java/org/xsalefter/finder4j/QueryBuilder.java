 ...
 * @param <K> {@link Map} key of {@link #getRestrictions()}.
 */
public interface QueryBuilder<K> {
	 ...
	 */
	QueryBuilder<K> select(String...fields);
	QueryBuilder<K> select(QueryBuilder<K> subQuery);
	QueryBuilder<K> join(String...fields);
	 ...
	 */
	QueryBuilder<K> where(Restriction...restrictions) throws NoRestrictionHandlerException;
	 ...
	 */
	QueryBuilder<K> where(List<Restriction> restrictions) throws NoRestrictionHandlerException;
	QueryBuilder<K> orderBy(Order...orders);
	QueryBuilder<K> groupBy(String...fields);

	/**
	 * <p>Get filtered {@link Restriction}s to bind to specifics data API 
	 * (JDBC/JPA).</p>
	 * <p>
	 ...
	 */
	List<ParameterRestriction<K>> getRestrictions();
