...
implements NullableRestrictionSpecs {
	...
	public void emptySelectWithNullableDiscard() {
		...
		restrictions.add(new JpaRestriction("name", RestrictionType.EQUAL, Nullable.DISCARD, "xsalefter"));
	...
	public void definedSelectWithNullableDiscard() {
		...
		restrictions.add(new JpaRestriction("birthDate", RestrictionType.EQUAL, Nullable.DISCARD, birth));
		restrictions.add(new JpaRestriction("gender", RestrictionType.EQUAL, Nullable.DISCARD));
	...
	public void definedSelectWithNullableKeep() {
		...
		restrictions.add(new JpaRestriction("name", RestrictionType.EQUAL, Nullable.KEEP, RestrictionLogic.OR));
		restrictions.add(new JpaRestriction("birthDate", RestrictionType.EQUAL, Nullable.KEEP, birth));
		restrictions.add(new JpaRestriction("gender", RestrictionType.EQUAL, Nullable.KEEP, RestrictionLogic.OR, Gender.Male));
		restrictions.add(new JpaRestriction("gender", RestrictionType.EQUAL, Nullable.KEEP));
